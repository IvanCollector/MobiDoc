    ...
    $.extend($.jqx._jqxGrid.prototype, {
        _initpager: function () {
            ...
            if (!this.pagerrenderer) {
                ...
                this.pagershowrowscombo.jqxDropDownList({rtl: this.rtl, source: source, enableBrowserBoundsDetection: true, keyboardSelection: false, autoDropDownHeight: true, width: 44, height: 16, theme: this.theme });
                var selectedindex = 0;
                ...
                var me = this;
                this.pagershowrowscombo.off('select');
                this.pagershowrowscombo.on('select', function (event) {
                    if (event.args) {
