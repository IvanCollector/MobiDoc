    ...
    $.extend($.jqx._jqxDropDownList.prototype, {
        ...
        renderSelection: function () {
            ...
            if (item == null) {
                ...
                $.jqx.utilities.html(spanElement, this.promptText);
        ...
        clearSelection: function (render) {
            ...
            $.jqx.utilities.html(this.dropdownlistContent, this.promptText);
        },
