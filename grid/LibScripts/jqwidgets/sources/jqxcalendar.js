...
(function ($) {
    ...
    $.extend($.jqx._jqxCalendar.prototype, {
        defineInstance: function () {
            ...
            if (this.monthNameFormat == undefined) {
        ...
        createInstance: function (args) {
            ...
            $(window).on('resize.calendar' + this.element.id, function () {
        ...
        renderTitle: function (month) {
            ...
            var title = $.global.format(this.value.dateTime, this._getTitleFormat(), this.culture);
            if (this.view == "decade") {
                var startText = $.global.format(this._renderStartDate, this._getTitleFormat(), this.culture);
                var endText = $.global.format(this._renderEndDate, this._getTitleFormat(), this.culture);
                title = startText + " - " + endText;
            }
            else if (this.view == "centuries") {
                var startText = $.global.format(this._renderCenturyStartDate, this._getTitleFormat(), this.culture);
                var endText = $.global.format(this._renderCenturyEndDate, this._getTitleFormat(), this.culture);
                title = startText + " - " + endText;
            }
        ...
        refreshViews: function (month, firstDay, calendarID) {
            ...
            for (var i = 0; i < 3; i++) {
                for (var j = 0; j < 4; j++) {
                    ...
                    var text = "";
                    if (this.view == "year") {
                        var monthNames = $.global.culture.calendar.months.names;
                        var monthString = monthNames[i * 4 + r];

                        // Possible values: default, shortest, firstTwoLetters, firstLetter, full
                        switch (this.monthNameFormat) {
                            case 'default':
                                monthString = $.global.culture.calendar.months.namesAbbr[i * 4 + r];
                                break;
                            case 'shortest':
                                monthString = $.global.culture.calendar.months.namesShort[i * 4 + r];
                                break;
        ...
        renderCalendarCells: function (month, firstDay, calendarID, switchViews) {
            ...
            var cellsTable = $("<table role='grid' style='width: 100%; height: 100%;' cellspacing='2' cellpadding='1' id=" + 'cellTable' + calendarID.toString() + ">" +
               "<tr role='row' id='row1'>" +
               "<td role='gridcell' id='cell11'></td>" + "<td role='gridcell' id='cell12'></td>" + "<td role='gridcell' id='cell13'></td>" + "<td role='gridcell' id='cell14'></td>" + "<td role='gridcell' id='cell15'></td>" + "<td role='gridcell' id='cell16'></td>" + "<td role='gridcell' id='cell17'></td>" +
               "</tr>" +
               "<tr role='row' id='row2'>" +
               "<td role='gridcell' id='cell21'></td>" + "<td role='gridcell' id='cell22'></td>" + "<td role='gridcell' id='cell23'></td>" + "<td role='gridcell' id='cell24'></td>" + "<td role='gridcell' id='cell25'></td>" + "<td role='gridcell' id='cell26'></td>" + "<td role='gridcell' id='cell27'></td>" +
               "</tr>" +
               "<tr role='row' id='row3'>" +
               "<td role='gridcell' id='cell31'></td>" + "<td role='gridcell' id='cell32'></td>" + "<td role='gridcell' id='cell33'></td>" + "<td role='gridcell' id='cell34'></td>" + "<td role='gridcell' id='cell35'></td>" + "<td role='gridcell' id='cell36'></td>" + "<td role='gridcell' id='cell37'></td>" +
               "</tr>" +
               "<tr role='row' id='row4'>" +
               "<td role='gridcell' id='cell41'></td>" + "<td role='gridcell' id='cell42'></td>" + "<td role='gridcell' id='cell43'></td>" + "<td role='gridcell' id='cell44'></td>" + "<td role='gridcell' id='cell45'></td>" + "<td role='gridcell' id='cell46'></td>" + "<td role='gridcell' id='cell47'></td>" +
               "</tr>" +
               "<tr role='row' id='row5'>" +
               "<td role='gridcell' id='cell51'></td>" + "<td role='gridcell' id='cell52'></td>" + "<td role='gridcell' id='cell53'></td>" + "<td role='gridcell' id='cell54'></td>" + "<td role='gridcell' id='cell55'></td>" + "<td role='gridcell' id='cell56'></td>" + "<td role='gridcell' id='cell57'></td>" +
               "</tr>" +
               "<tr role='row' id='row6'>" +
               "<td role='gridcell' id='cell61'></td>" + "<td role='gridcell' id='cell62'></td>" + "<td role='gridcell' id='cell63'></td>" + "<td role='gridcell' id='cell64'></td>" + "<td role='gridcell' id='cell65'></td>" + "<td role='gridcell' id='cell66'></td>" + "<td role='gridcell' id='cell67'></td>" +
               "</tr>" +
               "</table>"
           );
                           ...
                           if (cell != null && cell != undefined) {
                               ...
                               if (me.getMinDate() <= date && date <= me.getMaxDate()) {
                                   if (!cell.isDisabled) {
                                       ...
                                       else me._selectDate(cell.getDate(), 'mouse', event.shiftKey);
                                   }
                               }
                           }
                           return result;
        ...
        renderColumnHeader: function (month) {
            ...
            var columnHeader = $("<table role='grid' style='border-spacing: 0px; border-collapse: collapse; width: 100%; height: 100%;' cellspacing='0' cellpadding='1' id='columnHeader'>" +
               "<tr role='row' id='columnHeader'>" +
               "<td role='gridcell' id='columnCell1'></td>" + "<td role='gridcell' id='columnCell2'></td>" + "<td role='gridcell' id='columnCell3'></td>" + "<td role='gridcell' id='columnCell4'></td>" + "<td role='gridcell' id='columnCell5'></td>" + "<td role='gridcell' id='columnCell6'></td>" + "<td role='gridcell' id='columnCell7'></td>" +
               "</tr>" +
               "</table>"
            );
