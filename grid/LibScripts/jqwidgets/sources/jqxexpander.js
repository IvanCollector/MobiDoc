...
(function ($) {
    ...
    $.extend($.jqx._jqxExpander.prototype, {
        ...
        defineInstance: function () {
            ...
            //// events
            this.events = ['expanding', 'expanded', 'collapsing', 'collapsed'];
        },
        ...
        expand: function () {
            if (this.disabled == false && this.expanded == false && this._expandChecker == 1) {
                ...
                if (this.headerPosition == 'top') {
                    this._arrow.removeClass(this.toThemeProperty("icon-arrow-down"));
                    this._arrow.removeClass(this.toThemeProperty("jqx-expander-arrow-top"));
                    this._arrow.addClass(this.toThemeProperty("icon-arrow-up"));
                    ...
                    this._arrow.removeClass(this.toThemeProperty("icon-arrow-up"));
                    this._arrow.removeClass(this.toThemeProperty("jqx-expander-arrow-bottom"));
                    this._arrow.addClass(this.toThemeProperty("icon-arrow-down"));
                ...
                switch (this.animationType) {
                    case 'slide':
                        if (this.headerPosition == 'top') {
                            this._content.slideDown(this.expandAnimationDuration, this.easing, function () {
                                me.expanded = true;
                                me._header.attr("aria-expanded", true);
                                me._content.attr("aria-hidden", false);
                                me._raiseEvent('1');
                    ...
                    case 'none':
                        ...
                        this.expanded = true;
                        this._header.attr("aria-expanded", true);
                        this._content.attr("aria-hidden", false);
                        this._raiseEvent('1');
                    ...
                    case 'slide':
                        if (this.headerPosition == 'top') {
                            this._content.slideUp(this.collapseAnimationDuration, this.easing, function () {
                                me.expanded = false;
                                me._header.attr("aria-expanded", false);
                                me._content.attr("aria-hidden", true);
                                me._raiseEvent('3');
                            });
                        } else if (this.headerPosition == 'bottom') {
                            this._content.animate({
        ...
        render: function () {
            ...
            if (this.headerPosition == 'top') {
                ...
                this._header_temp = this.host.children("div:eq(1)");
            };
            ...
            if (this.headerPosition == 'top') {
                ...
                this._header = this.host.children("div:eq(1)");
                this._content = this.host.children("div:eq(0)");
            };
        ...
        _setSize: function () {
            ...
            var padding = parseInt(this._header_text.css('padding-left'));
            if (this.rtl) {
                var padding = parseInt(this._header_text.css('padding-right'));
            }
            if (isNaN(padding)) padding = 0;

            if (this.showArrow == true && this.width != "auto") {
                this._header_text.width(this._header.width() - this._arrow.width() - padding);
            } else {
                this._header_text.width("auto");
            };
            this._content.width(this._header.width());
            ...
            if (this.height == "auto") {
                ...
                this._content.height(this.host.height() - this._header.height());
                this._contentHeight = this._content.height();
            };
        ...
        _toggle: function () {
            ...
            if (this._isTouchDevice == false) {
                ...
                if (this.toggleMode != "none") {
                    this.addHandler(this._header, 'touchstart.expander' + this.widgetID, function () {
                        me._animate();
                    });
                } else {
                    return;
        ...
        _focus: function () {
            ...
            this.addHandler(this._header, 'focus.expander' + this.widgetID, function () {
                me.focusedH = true;
                me._header.attr("aria-selected", true);
            ...
            this.addHandler(this._header, 'blur.expander' + this.widgetID, function () {
                me.focusedH = false;
                me._header.attr("aria-selected", false);
