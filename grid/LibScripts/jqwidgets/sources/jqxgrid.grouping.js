    ...
    $.extend($.jqx._jqxGrid.prototype, {
        ...
        _rendergroupcolumn: function (text, groupcolumn) {
            ...
            if (this.closeablegroups) {
                ...
                var closebutton = '<div style="float: ' + fl + '; min-height: 16px; min-width: 18px;"><div style="position: absolute; left: 100%; top: 50%; margin-left: -18px; margin-top: -8px; float: none; width: 16px; height: 16px;" class="' + this.toThemeProperty('icon-close') + '"></div></div>';
                ...
                if (this.rtl) {
                    var closebutton = '<div style="float: ' + fl + '; min-height: 16px; min-width: 18px;"><div style="position: absolute; left: 0px; top: 50%; margin-top: -8px; float: none; width: 16px; height: 16px;" class="' + this.toThemeProperty('icon-close') + '"></div></div>';
                    if ($.jqx.browser.msie && $.jqx.browser.version < 8) {
                        closebutton = '<div style="float: left; min-height: 16px; min-width: 18px;"><div style="position: absolute; left: 0px; top: 50%; margin-top: -8px; float: none; width: 16px; height: 16px;" class="' + this.toThemeProperty('icon-close') + '"></div></div>';
                    }
                }
        ...
        _rendergroup: function (groupslength, tablerow, renderrow, columnstart, columnend, renderedrows, tablewidth) {
            ...
            if (this.rtl) {
                ...
                cellToRender.style.width = tablewidth + parseInt(scrollValue) - indent + 'px';
                $cellToRender.addClass(this.toThemeProperty('jqx-rtl'));
                var zIndex = $cellToRender.css('z-index');
                $cellToRender.css('z-index', zIndex + tablerow.cells.length);
